...
Java jre 8
Information
These ansible roles install and setup flink master-slave Here we have to specify varibles which are used for configuration of flink master and slave in vars folder.e.g, version, master_ip , slave_ip ##Steps to run playbook##
